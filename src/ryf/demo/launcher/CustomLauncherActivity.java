...
public class CustomLauncherActivity extends ListActivity {
	Intent mIntent;
	...
	private class ActivityAdapter extends BaseAdapter implements Filterable {
		...
		public ActivityAdapter(IconResizer resizer) {
			...
			mInflater = (LayoutInflater) CustomLauncherActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	...
	public class IconResizer {
		...
		public IconResizer() {
			...
			final Resources resources = CustomLauncherActivity.this.getResources();
	...
	private void updateAlertTitle() {
		...
		// findViewById(com.android.internal.R.id.alertTitle);
		// if (alertTitle != null) {
	...
	private void updateButtonText() {
		...
		// findViewById(com.android.internal.R.id.button1);
	...
	/**
	 * Override to call setContentView() with your own content view to customize
	 * the list layout.
	 */
...
//		Intent intent2 = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.parse("package:" + intent.getComponent().getPackageName()));
